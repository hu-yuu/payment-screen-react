...
const Tab1Content = (props) => {
    ...
    var [sehir, setSehir] = useState("")
    var [kurum, setKurum] = useState("")
    var [kurum2, setKurum2] = useState("")
    var [kod, setKod] = useState("")
    var { setData, data, values, setTarih, tarih } = props
    ...
    const handleDataSubmit = (e) => {
        ...
        document.getElementById("pills-profile-tab").disabled = false
        ...
        <div className="container ml-5 mb-3 ">
            ...
            <form>
                <div className="row mt-3 ml-3 first-tab-margin">
                    <div className="col-lg-8 col-xs-6 ">
                        ...
                        <select className="form-control" id="sehirler" name="sehirler" onChange={handleSehirChange}>
                            <option selected disabled value value="def">Şehir Seçiniz</option>
                ...
                <div className="row mt-3 ml-3 first-tab-margin">
                    <div className="col-lg-8 col-xs-6">
                        ...
                        <select className="form-control" id="kurumlar" name="kurumlar" onChange={
                            ...
                            <option selected disabled value value="def">Kurum Seçiniz</option>
                ...
                <div className="row d-flex justify-content-center">
                    <button id="gonderButton" className="btn btn-primary mt-4 w-25" onClick={handleDataSubmit}  >Gönder</button>
